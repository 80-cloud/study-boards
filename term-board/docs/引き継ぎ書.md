...
- **主要13モード実装・本番公開済み**（4択/暗記カード/用語辞典/学ぶ/面接練習/模擬面接/解説集/ダッシュボード/振り返り/自己PR/マイ問題/逆質問）。用語**203語**。オープンPRなし・main整合済み。
...
### ② 用語データの正確性レビュー＋出典確定（203語）✅ 実施済（#363。以後 #391 で+15、#393 で+12＋既存2件改良）
